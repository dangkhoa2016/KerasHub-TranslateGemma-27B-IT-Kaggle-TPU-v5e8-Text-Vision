...
class ReleaseWorkflowTests(unittest.TestCase):
    def test_tag_release_workflow_invokes_verified_artifact_builder(self):
        ...
        self.assertIn("scripts/release_contract.py", text)
        self.assertIn("bash scripts/test_unit.sh", text)
        self.assertIn("bash scripts/build_release_artifacts.sh", text)
